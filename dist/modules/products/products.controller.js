...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get paginated product list' }),
    (0, swagger_1.ApiQuery)({ name: 'page', required: false, example: 1 }),
    (0, swagger_1.ApiQuery)({ name: 'limit', required: false, example: 10 }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Product list fetched' }),
    (0, swagger_1.ApiOperation)({ summary: 'Get paginated product list' }),
    (0, swagger_1.ApiQuery)({ name: 'page', required: false, example: 1 }),
    (0, swagger_1.ApiQuery)({ name: 'limit', required: false, example: 10 }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Product list fetched' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get a product by its ID' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'UUID of the product' }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'slug', description: 'Unique slug of the product' }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: 'Product fetched successfully',
        type: product_entity_1.Product,
